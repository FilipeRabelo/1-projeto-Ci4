                  ...
                  <?php if (!empty($produtos)) : ?>
                    ...
                    <?php foreach ($produtos as $produto) : ?>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="/produtos/ver/<?= $produto["id_produto"] ?>" class="btn btn-primary"><i class="fas fa-search"></i>
                          </a>

                          <a href="/produtos/editar/<?= $produto["id_produto"] ?>" class="btn btn-warning"><i class="fas fa-edit"></i>
                          </a>
